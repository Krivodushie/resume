...
const translations = {
	ru: {
        ...
        ,"exc1": "В 2021 году начал активно изучать основы вёрстки и JavaScript. Мне понравилось и я вовлёк в это дело свою подругу Амину, с которой в итоге мы до сих пор собратья по мозгу и совместной разработке."
	...
	, en: {
		...
		, "iexp": "Experience: More than 3 years"
		, "hardSkills": "HARD SKILLS"
		, "softSkills": "SOFT SKILLS"
        ...
        ,"exc1": "In 2021, I started actively studying the basics of layout and JavaScript. I enjoyed it and got my friend Amina involved in this, and in the end, we are still brain buddies and co-developers."
